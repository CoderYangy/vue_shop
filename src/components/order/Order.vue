           ...
           <template slot-scope="scope">
            ...
            <el-table-column label="操作" >
                <template slot-scope="scope">
                    ...
                    <el-button type="success" icon="el-icon-location" size="mini" @click="showBoxnews"></el-button>
                </template>
                </el-table-column> 
        </el-table>
...
<el-dialog
  ...
  <span slot="footer" class="dialog-footer">
    <el-button @click="isshoweditBox = false">取 消</el-button>
    <el-button type="primary" @click="isshoweditBox = false">确 定</el-button>
  </span>
</el-dialog>
...
<el-dialog
  ...
  <el-timeline >
    <el-timeline-item
      v-for="(activity, index) in goodsInfo"
      :key="index"
